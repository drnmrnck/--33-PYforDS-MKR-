...
# ====================================================================
# Прізвище, ім'я, по батькові: Мирончук Дарина Юріївна
# Група:                      ЗК-33
# Дата виконання:              15.05.2026
# ====================================================================
...
У ході роботи було виконано аналіз метеорологічних даних, отриманих із бази MySQL. На першому етапі дані були завантажені в Python, після чого було проведено первинні розрахунки за допомогою NumPy. Далі набір даних було очищено від дублів, пропущених значень і помилкових показників, які могли вплинути на правильність результатів. Після очищення було визначено основні кліматичні характеристики міст, зокрема середню температуру, кількість опадів і сезонні зміни температури. За результатами аналізу найтеплішим містом виявився Київ, а найхолоднішим - Одеса. Найбільше опадів у Харкові. Також було визначено аномальний місяць - листопад 2023 року, у якому температура помітно відрізнялася від звичайного значення для цього періоду.  
"""
